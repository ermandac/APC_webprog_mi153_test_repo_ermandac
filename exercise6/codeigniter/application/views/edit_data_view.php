...
<div id="body">
 <div id="content">
    ...
    <td><input type="text" name="city_name" placeholder="City" value="<?php echo $fetched_row['city_name']; ?>" required /></td>
	 ...
	 <tr>
    <td><input type="text" name="contact_no" placeholder="City" value="<?php echo $fetched_row['contact_no']; ?>" required /></td>
    </tr>
	 <tr>
    <td><input type="text" name="email" placeholder="City" value="<?php echo $fetched_row['email']; ?>" required /></td>
    </tr>
    <tr>
    <td>
